...
const getStatusTotals = require('./links').getStatusTotals;
 ...
 * @param {string} key    the key in data to modify
 * @param {object} data    the data object to add
 * @param {boolean} replace push the data, or replace it
 * @return {Object}     Updated object
 *
 */
const setData = exports.setData = function(dataObj, key, data, replace) {
 ...
 */
exports.dataClean = function(dataObj, visitedUrls, linkCount, opts, custom) {
  ...
  setData(dataObj, 'custom', custom, true);
